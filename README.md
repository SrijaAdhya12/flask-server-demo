    updated on: 05th December 2025, Friday

<div align=center>
    <a href="https://github.com/SrijaAdhya12/flask-server-demo">
        <img width="200" src="https://img.icons8.com/?size=1000&id=46874" alt="flask-server-demo">
    </a>
    <p style="font-family: roboto, calibri; font-size:12pt; font-style:italic"> A good one liner description here </p>
    <a src="https://github.com/SrijaAdhya12/flask-server-demo/forks">
        <img alt="GitHub forks" src="https://img.shields.io/github/forks/SrijaAdhya12/flask-server-demo">
    </a>
</div>

# [Flask Server Demo](https://github.com/SrijaAdhya12/flask-server-demo)
...
2. Go to [**Security**](https://github.com/SrijaAdhya12/flask-server-demo/security) tab.
3. Click on **Security Overview**.
4. Click on `Enable Dependabot alerts` button.

- Enable Code Scanning Alerts

1. Go to [Code security and analysis](https://github.com/SrijaAdhya12/flask-server-demo/settings/security_analysis#code_scanning_settings) section in settings.
...
<div align="center">
    <a href="https://github.com/SrijaAdhya12/flask-server-demo/graphs/contributors">
        <img src="https://contrib.rocks/image?repo=SrijaAdhya12/flask-server-demo" alt="contributors"/>
    </a>
</div>
